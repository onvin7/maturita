    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">Nová Flash News</h1>
                            ...
                            <form method="POST" action="/admin/flashnews/store">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              maxlength="500" 
                                              required
                                              placeholder="Zadejte název flash news..."><?= htmlspecialchars($_POST['title'] ?? '') ?></textarea>
                                    <div class="form-text">
                                        <span id="charCount">0</span>/500 znaků
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="type" name="type">
                                                <option value="custom" <?= ($_POST['type'] ?? '') === 'custom' ? 'selected' : '' ?>>Vlastní</option>
                                                <option value="news" <?= ($_POST['type'] ?? '') === 'news' ? 'selected' : '' ?>>Novinky</option>
                                                <option value="tech" <?= ($_POST['type'] ?? '') === 'tech' ? 'selected' : '' ?>>Technologie</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Vytvořit Flash News
                                    </button>
                                    <a href="/admin/flashnews" class="btn btn-secondary">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="mt-3">Tipy:</h6>
                            <ul class="small">
                                <li>Název by měl být stručný a výstižný</li>
                                <li>Můžete použít HTML tagy pro formátování</li>
                                <li>Neaktivní flash news se nezobrazují na webu</li>
                            </ul>
                        </div>
                    </div>
                </div>
